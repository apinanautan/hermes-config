# Task: ถาม ChatGPT เรื่อง image generation via link

- **From:** Hermes-PC (routed from Telegram)
- **Target:** OpenClaw-PC
- **Objective:** เปิด ChatGPT link แล้วถามคำถามเรื่อง image generation integration
- **Steps:**
...
- **Expected Report:** 
  ...
  - Code/command ที่เอาไป implement ได้
